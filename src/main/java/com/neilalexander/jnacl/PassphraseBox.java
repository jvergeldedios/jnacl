...
public class PassphraseBox {
    ...
    public String decrypt(String nonce, String ciphertext) {
        this.nonce = NaCl.getBinary(nonce);
        this.ciphertext = NaCl.getBinary(ciphertext);
    ...
    public EncryptedMessage encrypt(String message) {
        ...
        encrypted.ciphertext = new String(NaCl.asHex(this.ciphertext));
        encrypted.nonce = new String(NaCl.asHex(this.nonce));
        encrypted.salt = new String(NaCl.asHex(this.salt));
